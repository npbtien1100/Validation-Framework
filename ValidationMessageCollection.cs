...
namespace ValidationFramework
{
    ...
    {
        List<ValidationMessage> messageCollection = new List<ValidationMessage>();
        ...
        /// return value
        /// </returns>
        public ValidationMessageCollection this[IValidatable validationSource, string propertyName = null]
        {
            get
            {
        ...
        public new void Insert(int index, ValidationMessage message)
        {
            ...
            ValidationMessageCollection messages = this[message.ValidationSource, message.PropertyName];
