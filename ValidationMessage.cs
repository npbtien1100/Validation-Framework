...
namespace ValidationFramework
{
    ...
    public class ValidationMessage
    {
        ...
        public ValidationMessage(string defaultMessage, IEnumerable<object> messageParameters, IValidatable validationSource, string propertyName, ValidationLevel validationLevel = ValidationLevel.Error)
          : this()
        {
            ...
            this.Message = FormatMessage(defaultMessage, messageParameters);
